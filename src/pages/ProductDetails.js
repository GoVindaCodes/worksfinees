...
//   //       const response = await ProductServices.getRatingsForProduct(id);
//   //       console.log("Fetched ratings:", response);
//   //       // extract ratings array from response
//   //       const fetchedRatings = response.ratings;
//   //       // set ratings in component state
...
//   //   // fetch ratings from backend on component mount
//   //   fetchRatings();
//   // }, [id]); // 
//   // const [ratings, setRatings] = useState([]);
//   // const fetchRatings = async () => {
//   //   try {
//   //     const fetchedRatings = await ProductServices.getRatingsForProduct(id);
//   //     setRatings(fetchedRatings);
//   //   } catch (error) {
//   //     console.error("Error fetching ratings:", error);
//   //   }
  ...
  return (
    <>
      ...
      <ReviewModal
        ...
        ratings={ratings}
      />
      <button className="focus:outline-none" onClick={handleToggleReviewModal}>{t("Write a Review")}</button>
      ...
      <div>
        <div>
          <button className="focus:outline-none" onClick={handleOpenOrderModal}>{t("BuyNow")}</button>
        </div>
        <Modal open={isOrderModalOpen} onClose={handleCloseOrderModal}>
          <ModalBody className="text-center custom-modal px-8 pt-6 pb-4">
            <OrderProcessModal onSubmitOrder={handleSubmitOrder} id={id} selectedPaymentMethod={defaultMethodDetails} />
